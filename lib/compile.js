            ...
            return function linkComponentElement(scope, parentNode, contentLinkFn) {
                ...
                for (var i = 0; i < numChildren; i++) {
                    ...
                    if (child.type == 'tag') {
                        ...
                        // FIXME: This is broken because we post-link more often than
                        // we pre-link. Need to find a solution where we can pre-link for
                        // each element a component produces.
                        decoratorPostLinkFn(scope, child);
                    }
